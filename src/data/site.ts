export const siteConfig = {
  ...
  partners: [
    {
      ...
      phone: "+91 9104635945",
      email: "devdarji1828@gmail.com",
      focus: "Full-Stack SaaS Architecture, Cloud Systems & API Protocols",
    },
    {
      name: "Deep Gadhiya",
      role: "Co-Founder & Technical Engineering Partner",
      phone: "+91 6353935950",
      email: "devdarji1828@gmail.com",
      focus: "Frontend Engineering, Applied AI Integrations & Product Delivery",
    }
  ],
  ...
  guarantees: [
    { title: "100% Code & IP Ownership", desc: "You own all source code, deployment assets, and architectural blueprints with zero vendor lock-in." },
    { title: "Production-Grade Scalability", desc: "Engineered for high concurrent throughput with microservices, clean database schemas, and global CDN caching." },
    { title: "Rigorous Zero-Bug Standards", desc: "Thorough end-to-end testing, strong TypeScript typing, and defensive security protocols." },
    { title: "Dedicated Post-Launch SLA", desc: "Continuous performance monitoring, infrastructure optimizations, and priority engineering support." }
  ],
